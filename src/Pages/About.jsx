                ...
                <div className="hero-content flex-col lg:flex-row-reverse">
                  <img src={picture} className="max-w-sm rounded-lg shadow-2xl" />   
                    <div>
                        ...
                        <p className="py-2 px-12">A passionate junior frontend web developer with a strong enthusiasm for creating beautiful and user-friendly websites. I have a solid foundation in HTML, CSS, and JavaScript, and I'm constantly expanding my knowledge to stay up-to-date with the latest web development trends and technologies.I have completed my graduation in Computer Science & Engineering.</p>
